  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        preis_eur: Number.parseFloat(formData.preis_eur),
        dauer_min: Number.parseInt(formData.dauer_min),
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {behandlungen?.map((behandlung) => (
                <tr key={behandlung.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{behandlung.name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{behandlung.kategorie || "-"}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{behandlung.dauer_min} Min.</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    <button onClick={() => handleDelete(behandlung.id)} className="text-red-600 hover:text-red-900">
                      Löschen
                    </button>
                  </td>
                </tr>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, dauer_min: e.target.value })}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, preis_eur: e.target.value })}
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Format: #RRGGBB (z.B. #3B82F6 für Blau)</p>
                </div>

...
export const metadata: Metadata = {
  ...
  description: 'Zentrale Kommandozentrale mit umfassenden Geschäftseinblicken für Kosmetikstudio-Operationen über alle Standorte hinweg mit Echtzeit-KPIs und Leistungsmetriken.',
};
